...
## Corpus Check
- 24 files · ~4,453 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 89 nodes · 113 edges · 14 communities (11 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `31d9ddc2`
...
## Knowledge Gaps
- **39 isolated node(s):** `Bindings`, `app`, `STATUS_COLORS`, `STATUS_LABELS`, `pedidos` (+34 more)
...
- **What connects `Bindings`, `app`, `STATUS_COLORS` to the rest of the system?**
